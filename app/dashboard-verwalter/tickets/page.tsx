  ...
  return (
        <div className="p-6 max-w-4xl mx-auto">
              <div className="flex items-center justify-between mb-6">
                      <div>
                                <h1 className="text-xl font-semibold text-white">Alle Tickets</h1>h1>
                                <p className="text-sm text-gray-400 mt-0.5">{tickets.length} Tickets insgesamt</p>p>
                      </div>div>
                      <Button onClick={() => router.push("/dashboard-verwalter/neues-ticket")}>+ Neues Ticket</Button>Button>
              </div>div>
                                ...
                                <Card key={t.id} className="cursor-pointer hover:border-[#00D4AA]/30 transition-colors !p-3"
                                              ...
                                              <div className="flex items-center gap-3">
                                                              ...
                                                              <div className="flex-1 min-w-0">
                                                                                <div className="text-sm font-medium truncate text-white">{t.titel}</div>div>
                                                              ...
                                                              <div className="flex items-center gap-2 flex-shrink-0">
                                                                {t.angebote && t.angebote.length > 0 && (
                                                                      <span className="text-sm font-medium text-[#00D4AA]">
                                                                                            ab &euro; {Math.min(...t.angebote.map((a: any) => a.preis)).toLocaleString("de")}
                                                                      </span>span>
                                                                                )}
