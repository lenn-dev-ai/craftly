        ...
        <Card className="p-8">
          ...
          {sessionReady === "missing" && (
            <div className="text-center">
              ...
              <h1 className="text-xl font-bold text-ink mb-2">Link abgelaufen</h1>
              <p className="text-sm text-ink-secondary mb-6">
                Der Link zum Zurücksetzen ist abgelaufen oder ungültig. Bitte fordern Sie einen neuen an.
              </p>
              <Link
                href="/passwort-vergessen"
                className="inline-block text-sm font-medium px-5 py-2.5 rounded-xl bg-accent text-white hover:bg-accent-hover transition-colors"
              >
          ...
          {sessionReady === "ok" && success && (
            <div className="text-center">
              ...
              <h1 className="text-xl font-bold text-ink mb-2">Passwort aktualisiert</h1>
              <p className="text-sm text-ink-secondary">Sie werden in wenigen Sekunden zum Login weitergeleitet…</p>
            </div>
          )}
          ...
          {sessionReady === "ok" && !success && (
            <>
              <div className="text-center mb-6">
                <h1 className="text-2xl font-bold text-ink mb-2">Neues Passwort festlegen</h1>
                <p className="text-sm text-ink-secondary">Wählen Sie ein sicheres Passwort für Ihr Konto.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {confirm && password !== confirm && (
                    <p className="text-xs text-danger mt-1">Passwörter stimmen nicht überein</p>
                  )}
                </div>
              </div>
