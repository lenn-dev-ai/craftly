    ...
    <div className="min-h-screen bg-surface text-ink">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-ink-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
            <p>
              {BETREIBER_NAME}<br />
              {BETREIBER_STRASSE}<br />
              {BETREIBER_PLZORT}
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">Haftung für Inhalte</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">Haftung für Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">Streitschlichtung</h2>
            <p>
