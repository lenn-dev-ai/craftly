  ...
  return (
    <div className="min-h-screen bg-surface text-ink">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-ink-muted mb-8">Stand: {STAND}</p>

        {!LIVE && (
          <div className="mb-8 p-4 rounded-xl border-2 border-[#C4956A] bg-warm-light text-warm-dark text-sm">
        ...
        <div className="space-y-8 text-ink-secondary leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 1 Geltungsbereich und Vertragspartner</h2>
            <p>
              (1) Diese Allgemeinen Geschäftsbedingungen (nachfolgend „AGB“) regeln die Nutzung der unter <a href="https://reparo-app.netlify.app" className="text-accent hover:underline">reparo-app.netlify.app</a> betriebenen Online-Plattform (nachfolgend „Plattform“ oder „Reparo“) durch registrierte Nutzer.
            </p>
            <p className="mt-3">
              (2) Anbieter der Plattform und Vertragspartner ist {BETREIBER_NAME}, {BETREIBER_STRASSE}, {BETREIBER_PLZORT} (nachfolgend „Anbieter“). Kontakt: <a href={`mailto:${KONTAKT_EMAIL}`} className="text-accent hover:underline">{KONTAKT_EMAIL}</a>.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 2 Definitionen</h2>
            <ul className="list-disc list-inside space-y-1.5">
              <li><strong className="text-ink">Verwalter:</strong> Hausverwaltung oder Eigentümer, die über die Plattform Aufträge an Handwerksbetriebe vergeben.</li>
              <li><strong className="text-ink">Handwerker:</strong> Selbständige Handwerksbetriebe, die über die Plattform Angebote auf ausgeschriebene Aufträge abgeben.</li>
              <li><strong className="text-ink">Mieter:</strong> Bewohner von Mieteinheiten, die über die Plattform Schadensmeldungen an ihre Hausverwaltung übermitteln.</li>
              <li><strong className="text-ink">Auftrag:</strong> Eine vom Verwalter eingestellte Anfrage zur Ausführung von Handwerksleistungen.</li>
              <li><strong className="text-ink">Auktion:</strong> Ein zeitlich begrenzter Vorgang, bei dem mehrere Handwerker auf einen Auftrag bieten können.</li>
              <li><strong className="text-ink">Werkvertrag:</strong> Der zwischen Verwalter und Handwerker nach Auftragsvergabe entstehende Vertrag.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 3 Leistungen des Anbieters</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 4 Registrierung und Nutzerkonto</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 5 Provisionsregelung</h2>
            <p>
              (1) Bei erfolgreicher Vermittlung eines Auftrags zwischen Verwalter und Handwerker fällt eine Vermittlungsprovision an. Diese wird ausschließlich vom <strong className="text-ink">Verwalter</strong> getragen; für Handwerker und Mieter ist die Nutzung kostenfrei.
            </p>
            <p className="mt-3">
              (2) Die Standard-Provision beträgt <strong className="text-ink">5 % netto auf den Auftragswert</strong>. Sie wird zum Zeitpunkt der Auftragsvergabe rechnerisch ermittelt und in einem Audit-Trail (Provisions-Snapshot) dauerhaft gespeichert.
            </p>
            <p className="mt-3">
              (3) Bei kurzfristigen Aufträgen kann ein Aufschlag („Surge“) auf die Standardprovision anfallen:
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li><strong className="text-ink">Notfall</strong> (sofortige Vermittlung): + 20 % auf die Provision (effektiv 6 %)</li>
              <li><strong className="text-ink">Zeitnah</strong> (48-Stunden-Auktion): + 10 % auf die Provision (effektiv 5,5 %)</li>
              <li><strong className="text-ink">Planbar</strong> (Standard-Auktion): kein Aufschlag (5 %)</li>
            </ul>
            <p className="mt-3">
              (4) Verwalter, deren Konto vor dem auf dem Profil hinterlegten Datum „early_adopter_bis“ registriert wurde, zahlen für einen begrenzten Zeitraum von <strong className="text-ink">90 Tagen ab Registrierung</strong> keine Provision (0 %). Der Aufschlag nach Absatz 3 entfällt während dieses Zeitraums.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 6 Pflichten der Nutzer</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 7 Bewertungssystem</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 8 Haftung</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 9 Datenschutz</h2>
            <p>
              Der Schutz personenbezogener Daten ist dem Anbieter wichtig. Einzelheiten zur Verarbeitung sind in der{" "}
              <Link href="/datenschutz" className="text-accent hover:underline">Datenschutzerklärung</Link> geregelt.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 10 Vertragslaufzeit und Kündigung</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 11 Streitbeilegung</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">§ 12 Schlussbestimmungen</h2>
        ...
        <div className="mt-12 pt-8 border-t border-line flex gap-6 text-sm text-ink-muted">
