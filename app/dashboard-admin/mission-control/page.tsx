...
//
// Bewusst MINIMAL gehalten und neben dem bestehenden /dashboard-admin
// platziert (nicht ersetzt). So kann Lennart vergleichen und entscheiden,
// ob das alte Dashboard weichen soll. Verwendet ausschließlich Endpoints
// die in Sprint AH gebaut wurden:
//   - GET /api/admin/live
//   - GET /api/admin/action-items
//   - GET /api/admin/activity
//   - GET /api/admin/health
//
// Refresh-Intervalle bewusst lang: 30s/60s/5min/60s — Admin-Page wird
// selten offen gelassen, kein Bedarf für aggressives Polling.
