  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <Card className="p-8 text-center">
          {status === "checking" && (
            <>
              ...
              <h1 className="text-xl font-bold text-ink mb-2">E-Mail wird bestätigt…</h1>
              <p className="text-sm text-ink-secondary">Einen Moment bitte.</p>
            </>
          )}
          ...
          {status === "ok" && (
            <>
              ...
              <h1 className="text-xl font-bold text-ink mb-2">E-Mail bestätigt</h1>
              <p className="text-sm text-ink-secondary">Sie werden zu Ihrem Dashboard weitergeleitet…</p>
            </>
          )}
          ...
          {status === "fehler" && (
            <>
              ...
              <h1 className="text-xl font-bold text-ink mb-2">Bestätigung fehlgeschlagen</h1>
        ...
        <div className="mt-8 flex justify-center gap-6 text-xs text-ink-muted">
