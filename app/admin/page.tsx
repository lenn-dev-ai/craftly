      ...
      <div className="max-w-5xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {rollen.map(r => (
            <div
              ...
              className="group cursor-pointer bg-white rounded-xl border border-line overflow-hidden hover:border-accent/30 hover:shadow-md transition-all">
              {/* Colored top bar */}
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="text-sm font-medium text-ink-muted hover:text-danger transition-colors">
            Ausloggen
          </button>
        </div>
      </div>
