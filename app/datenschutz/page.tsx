    ...
    <div className="min-h-screen bg-surface text-ink">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-ink-secondary leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">1. Verantwortlicher</h2>
            <p>
              Verantwortlich für die Datenverarbeitung auf dieser Plattform ist:<br />
              {BETREIBER_NAME}<br />
              {BETREIBER_STRASSE}<br />
              {BETREIBER_PLZORT}<br />
              E-Mail: <a href={`mailto:${KONTAKT_EMAIL}`} className="text-accent hover:underline">{KONTAKT_EMAIL}</a>
            </p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">2. Erhebung und Speicherung personenbezogener Daten</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">3. Rechtsgrundlage</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">5. Hosting (Netlify)</h2>
            <p>
              Diese Plattform wird über <strong className="text-ink">Netlify</strong> ausgeliefert (Netlify, Inc., 44 Montgomery Street, Suite 300, San Francisco, CA 94104, USA). Netlify übernimmt das Hosting der Webseite sowie das globale Content-Delivery (CDN). Beim Aufruf werden technische Verbindungsdaten (IP-Adresse, Zeitpunkt, abgerufene URL, Browser-Typ, Betriebssystem) verarbeitet, die ausschließlich der sicheren Auslieferung und Angriffserkennung dienen. Es besteht ein AVV gemäß Art. 28 DSGVO.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">6. Adress-Autocomplete (Photon)</h2>
            <p>
              Bei der Eingabe einer Adresse während der Registrierung oder beim Anlegen eines Tickets wird die Eingabe an <strong className="text-ink">Photon</strong> übermittelt, einen Open-Source-Geocoding-Dienst der Komoot GmbH (München, Deutschland), um Adressvorschläge zu liefern. Es werden keine Cookies gesetzt und keine Nutzerprofile gebildet.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">7. Übermittlung in Drittländer</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">8. Cookies (§ 25 TTDSG)</h2>
            <p>
              <strong className="text-ink">Notwendige Cookies:</strong> Diese Plattform verwendet ausschließlich technisch notwendige Cookies für Login-Sitzungen (Supabase Auth) und das Speichern der Cookie-Banner-Einwilligung. Diese sind gemäß § 25 Abs. 2 Nr. 2 TTDSG nicht einwilligungspflichtig.
            </p>
            <p className="mt-3">
              <strong className="text-ink">Optionale Cookies:</strong> Optionale Cookies (z.B. Reichweitenmessung) werden nur nach ausdrücklicher Einwilligung über den Cookie-Banner gesetzt. Die Einwilligung kann jederzeit widerrufen werden, indem die Cookie-Auswahl zurückgesetzt oder die gespeicherten Cookies im Browser gelöscht werden.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">9. Server-Log-Dateien</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">10. Speicherdauer</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">11. Ihre Rechte</h2>
            ...
            <p className="mt-3">
              ...
              <a href={`mailto:${KONTAKT_EMAIL}`} className="text-accent hover:underline">{KONTAKT_EMAIL}</a>.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">12. Datensicherheit</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">13. Beschwerderecht</h2>
            <p>
              ...
              <a href="https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
                bfdi.bund.de
              </a>
              .
            </p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">14. Änderungen dieser Datenschutzerklärung</h2>
            <p>
        ...
        <div className="mt-12 pt-8 border-t border-line flex gap-6 text-sm text-ink-muted">
          ...
          <Link href="/agb" className="hover:text-ink transition-colors">AGB</Link>
        </div>
      </main>
    </div>
  )
